...
const BlockButton = ({ title, styles, onClick, classNames }: Button) => {
  return (
    <div
      onClick={onClick}
      className={`h-[50px] rounded-full p-4 w-fit mt-4 mb-4  pl-10 pr-10 bg-green-600 hover:bg-green-300 text-[16px] capitalize text-white text-center font-semibold flex justify-center items-center ${classNames}`}
      style={styles}
