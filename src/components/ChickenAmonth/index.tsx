...
const ChickenAmonth = () => {
  return (
    <div className="w-full min-h-[350px] relative flex justify-center justify-items-center bg-[url('/pedoi-chicks.jpg')] bg-no-repeat bg-cover">
      <div className=" w-full h-[350px] font-bold text-[22px] md:text-[30px] text-white text-center bg-[rgba(0,0,0,0.8)] flex flex-col justify-center items-center ">
